"""The rollout baseline: a vendored copy of Lab 12's `baseline_agent.py`
(itself Lab 3's solution loop adapted to Lab 8's tasks).
...
(Lab 3, Q 1.4). This is the agent already running on the fleet; your
engine in `rollout/engine.py` decides whether a candidate may replace it.
"""
