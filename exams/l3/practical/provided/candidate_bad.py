"""A candidate release with a planted regression: a vendored copy of
Lab 12's `candidate_bad.py` (originally Lab 8's `buggy_agent.py`).
...
silent difference is exactly what your GATE stage must catch (Trace 10;
Trace 27).
"""
