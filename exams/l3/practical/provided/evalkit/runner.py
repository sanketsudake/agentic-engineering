"""Runner for the L3 practical (vendored from Lab 12, originally Lab 8's
solution `evalkit/runner.py`).

Infrastructure the tests call twice — once for the baseline, once for the
candidate — to build the GATE-stage eval reports. You built this in Lab 8.
"""
...
def run_eval(agent_fn: Callable[[dict], object], tasks: list[dict],
    ...
    attribute (see `provided/baseline_agent.py`).
    ...
    with a closure before putting it in this dict.
