"""Graders for Lab 12 (vendored from Lab 8's solution `evalkit/graders.py`).

You already built these in Lab 8; here they are infrastructure the release
gate scores with, not the exercise. Each grader takes the same two
