"""Runner for Lab 12 (vendored from Lab 8's solution `evalkit/runner.py`).

Infrastructure `release_gate()` calls twice — once for the baseline, once
for the candidate. You already built this in Lab 8.
"""
